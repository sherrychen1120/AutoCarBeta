# Training data is the image captured at each keyboard action of concern (forward, forward right,
# forward left, right, left). 
# Training label is keyboard action.
        ...
        try:
            ...
            while self.send_inst:
                ...
                if first != -1 and last != -1:
                    ...
                    roi = flipped_img[int(height/2):height, :]
...
if __name__ == '__main__':
    # host, port
    h, p = "192.168.1.157", 8000

    # serial port
    sp = "/dev/cu.usbmodem1411"
